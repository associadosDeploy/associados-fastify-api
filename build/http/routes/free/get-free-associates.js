...
var get_free_associates_exports = {};
__export(get_free_associates_exports, {
  getFreeAssociates: () => getFreeAssociates
});
module.exports = __toCommonJS(get_free_associates_exports);
...
// src/http/routes/free/get-free-associates.ts
function getFreeAssociates(app) {
