...
var get_free_courses_exports = {};
__export(get_free_courses_exports, {
  getFreeCourses: () => getFreeCourses
});
module.exports = __toCommonJS(get_free_courses_exports);
          ...
          response: {
            200: import_zod2.default.array(
              import_zod2.default.object({
                ...
                link: import_zod2.default.string().url(),
                ...
                user_id: import_zod2.default.string().nullable(),
